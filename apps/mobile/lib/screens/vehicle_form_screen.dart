    ...
    try {
      if (_isEditing) {
        await ApiService.updateVehicle(widget.vehicle!['id'] as String, {
          ...
          if (_yearCtrl.text.trim().isNotEmpty) 'year': int.tryParse(_yearCtrl.text.trim()),
          if (_colorCtrl.text.trim().isNotEmpty) 'color': _colorCtrl.text.trim(),
          if (_mileageCtrl.text.trim().isNotEmpty) 'mileage': int.tryParse(_mileageCtrl.text.trim()),
        });
      } else {
          ...
          child: Column(
            ...
            children: [
                ...
                _loadingCustomers
                    ...
                    : DropdownButtonFormField<String>(
                        ...
                        items: _customers.map((c) {
                          ...
                          final label = doc.isNotEmpty ? '${c['name']} ($doc)' : c['name'] as String;
              ...
              TextFormField(
                ...
                validator: (v) => v == null || v.trim().isEmpty ? 'Placa obrigatória' : null,
              ),
              ...
              TextFormField(
                ...
                validator: (v) => v == null || v.trim().isEmpty ? 'Marca obrigatória' : null,
              ),
              const SizedBox(height: 16),
              TextFormField(
                ...
                textCapitalization: TextCapitalization.words,
                validator: (v) => v == null || v.trim().isEmpty ? 'Modelo obrigatório' : null,
              ),
              const SizedBox(height: 16),
              Row(
                children: [
