/**
 * Admin SettingsPage — platform settings and password change.
...
/** Admin settings / profile page with password change. */
export function SettingsPage(): ReactNode {
  ...
  return (
    <div className="page">
      ...
      <p className="page-subtitle">Configurações da plataforma e perfil do administrador</p>

      <div className="card">
        <div className="card-body">
          <h2 className="section-title">Perfil do Administrador</h2>
          <div className="detail-grid">
            ...
            <div className="detail-item">
              ...
              <span className="detail-value">Administrador da Plataforma</span>
            </div>
          </div>
        </div>
      </div>
